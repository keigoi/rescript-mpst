...
import * as WebWorker$RescriptMpst from "./WebWorker.js";
...
function initWorkers(_g, mainrole, workers) {
  var match = Raw$RescriptMpst.destruct_polyvar(Curry._1(mainrole.role_label.closed_make, Raw$RescriptMpst.dontknow(undefined)));
...
function init(_g, _role) {
  return new Promise((function (resolve, _reject) {
                return WebWorker$RescriptMpst.WorkerSide.setOnMessage(function (e) {
                            var sess_dummy_witness = Raw$RescriptMpst.dontknow(undefined);
